...
5. **Usage**: When making requests, the client signs payment authorizations using the session key. The middleware validates the structure of the authorization and forwards it to the facilitator.
